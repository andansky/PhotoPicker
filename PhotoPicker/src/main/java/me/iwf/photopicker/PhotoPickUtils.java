...
public class PhotoPickUtils {
     ...
     * @param photos
     */
    public static void startPick(Activity context,int imgNum,ArrayList<String> photos){
        PhotoPicker.builder()
                .setPhotoCount(9)
                .setShowCamera(true)
                .setShowGif(true)
     ...
     * @param photos
     */
    public static void startPick(Activity context, Fragment fragment,int imgNum,ArrayList<String> photos){
        PhotoPicker.builder()
                .setPhotoCount(imgNum)
                .setShowCamera(true)
                .setShowGif(true)
                .setSelected(photos)
                .setPreviewEnabled(true)
